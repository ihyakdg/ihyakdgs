...
public:
    ...
    DialogBuilder* TextScalingString(const std::string& scale);

    DialogBuilder* EmbedData(const std::string& name, const std::string& value);
    template<typename T, typename std::enable_if_t<std::is_integral_v<T>, bool> = true>
    DialogBuilder* EmbedData(const std::string& name, T value);
    ...
    DialogBuilder* AddLabel(const std::string& label, eDirection direction =  LEFT, eSizeType size = SMALL);
    DialogBuilder* AddLabelWithIcon(const std::string& label, int32_t itemId, eDirection direction =  LEFT, eSizeType size = SMALL);
    DialogBuilder* AddCustomLabel(const std::string& label, const std::string& target, double top, double left, eSizeType size = SMALL);
    DialogBuilder* AddTextbox(const std::string& label);
    DialogBuilder* AddSmallText(const std::string& label);
    DialogBuilder* AddTextInput(const std::string& name, const std::string& label, const std::string& labelInside, int32_t maxLength);
    DialogBuilder* AddTextInputPassword(const std::string& name, const std::string& label, const std::string& labelInside, int32_t maxLength);
    DialogBuilder* AddTextboxInput(const std::string& name, const std::string& label, const std::string& textInside, int32_t maxLength, int32_t lines);
    DialogBuilder* AddButton(const std::string& name, const std::string& label, const std::string& buttonFlag = "noflags");

    DialogBuilder* EndDialog(const std::string& name, const std::string& cancel, const std::string& ok);
